...
import { User, Box, Document, DataLine, Setting, TrendCharts, ArrowDown, UserFilled, Lock, OfficeBuilding, Money, Warning } from '@element-plus/icons-vue'
        ...
        >
          ...
          >
            ...
            >
              <template #reference>
                <el-card
                  class="menu-card menu-card-clickable"
                  shadow="hover"
                >
                  <div class="card-content">
                    <el-icon
              ...
              <div class="system-menu-list">
                ...
                <div
                  class="system-menu-item"
                  @click="goToMaterialCategoryManage"
                >
                  <el-icon><Box /></el-icon>
                  <span>耗材分类管理</span>
                </div>
